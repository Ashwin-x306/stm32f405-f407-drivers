...
#ifndef INC_STM32F405XXX_USART_DRIVER_H_
#define INC_STM32F405XXX_USART_DRIVER_H_
...
typedef struct
{
	...
	uint8_t          TxBusyState;  /* communication state */
	uint8_t          RxBusyState;
}USART_Handle_t;
...
/*
 *@USART_FlagName  (to be used with USART_GetFlagStatus / USART_ClearFlag)
 */
...
#endif /* INC_STM32F405XXX_USART_DRIVER_H_ */
